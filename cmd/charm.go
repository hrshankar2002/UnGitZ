...
var charmCmd = &cobra.Command{
	Use:   "charm",
	Short: "It will open the directory in Pycharm",
	Long: `This command will help to open the unzipped folder to Pycharm.
	In order for this command to work, Pycharm should be installed in your system`,
...
func init() {
	...
	charmCmd.PersistentFlags().StringSliceVarP(&File_flag, "file", "f", []string{}, "Arguments:<file name>,<repo name>,<branch name>")
	charmCmd.PersistentFlags().StringVarP(&link_flag, "link", "l", "", "Argument:<URL>")
}
